(function() {
    ...
    function userController($mdSidenav, $mdBottomSheet, $log, $q, $scope, $element, Fullscreen, $mdToast, $animate) {
        ...
        $scope.place_grating=true;/** Place grating */
       // $scope.switch_disabled=true;
        ...
        $scope.placeGrating= function(){
            $scope.place_grating =! $scope.place_grating
            placeGratingFn($scope);/** Function defined in experiment.js file */
        }          
        ...
        /** Function for grating telescope  */
        $scope.gratingRotate = function() {
            gratingRotateFn($scope);/** Function defined in experiment.js file */
        }          
